...
#GROQ_API_KEY  = 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      - INCASE IF YOU WANT TO USE THIS API KEY
#HUGGINGFACE_API_KEY=  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                   - INCASE IF YOU WANT TO USE THIS API KEY
...
# My Weaviate URL and API Key
WEAVIATE_URL = "https://boho6ox7rmufpc3ezzzsqq.c0.asia-southeast1.gcp.weaviate.cloud"                             #- IF THIS IS OFFLINE LET ME KNOW
WEAVIATE_API_KEY = "Wk0yR3BFcTFwckRIZDJTWF9tTW85U3EvdUVaTkIyZ3p2ZDVMaSsxNjFmWDNTalRUSll2TTg3WElXS0tzPV92MjAw"     #- IF THIS IS OFFLINE LET ME KNOW
...
def main():
    ...
    html, body, [class*="css"] {
        ...
        background: linear-gradient(135deg, #f9f9f9 0%, #e9f2ff 100%);
    }
    .stApp {
        background: linear-gradient(135deg, #f9f9f9 0%, #e9f2ff 100%);
    }
    ...
    .stButton button:hover {
        ...
        box-shadow: 0px 6px 14px rgba(12,82,192,0.4);
    }
    .footer {
        position: fixed;
        left: 0;
    ...
    # Title
    st.markdown('<div class="title">📚  Document-Based Question Answering Application 🚀</div>', unsafe_allow_html=True)
    ...
    input_type = st.sidebar.selectbox("Select Input Type", [ "PDF", "Text", "DOCX", "TXT" , "Link"])
    
    #lOGICS FOR different input types IN INTERFACE 
    if input_type == 'PDF':
    ...
    st.markdown("""
    <div class="footer">
    Developed by Gihan Lakmal | Demo for SenzMate Interview Assessment 🚀
    </div>
    """, unsafe_allow_html=True)
